...
👉 Un router conosce SOLO:

- le reti direttamente collegate
...
- 2 router (Milano e Torino)
    
- ognuno collegato alla sua rete
...
👉 Milano NON conosce la rete di Torino

---

# 🔹 SOLUZIONE: ROUTE STATICHE

### Metodo 1 (NEXT HOP)

```id="09dx1h"
ip route 172.10.0.0 255.255.0.0 200.100.50.2
```

👉 significa:

- per arrivare alla rete 172.10.0.0
    
- passa dal router con IP 200.100.50.2
    

---

## 🔸 Metodo 2 (INTERFACCIA)

```id="rsqx3j"
ip route 172.10.0.0 255.255.0.0 fastEthernet 0/0
```

👉 dice:

- esci da questa interfaccia
...
👉 Devi configurarlo **su ENTRAMBI i router**

💡 Se no:

- uno sa dove andare
    
- l’altro NON sa tornare
...
👉 mostra tutte le reti conosciute

---

# 🔹 1️⃣2️⃣ ROUTING STATICO
...
- difficile su reti grandi
    

---

# 🔹 1️⃣3️⃣ ROUTING DINAMICO (RIP)

👉 i router si scambiano info automaticamente
...
- il router comunica queste reti agli altri
...
✅ un **mega riassunto di TUTTO (VLAN + routing + base)**  
✅ oppure una **simulazione interrogazione con domande del prof**
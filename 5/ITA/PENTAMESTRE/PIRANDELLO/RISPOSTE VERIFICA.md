...
## 5. Descrivete voce narrante, punto di vista e intreccio de _Il fu Mattia Pascal_, individuando somiglianze e differenze con _La coscienza di Zeno_.

Nel _Fu Mattia Pascal_ la voce narrante coincide con il protagonista stesso: è Mattia Pascal che racconta in prima persona la propria vicenda. La narrazione è quindi soggettiva, filtrata dalla sua memoria e dalla sua coscienza. Il punto di vista è interno, limitato e in parte inaffidabile, perché il lettore conosce i fatti solo attraverso la versione che Mattia decide di dare.

L’intreccio non segue un andamento lineare puramente cronologico, perché il romanzo comincia a vicenda già conclusa: Mattia si trova nella biblioteca e racconta retrospettivamente la propria storia. L’intero romanzo è quindi costruito come un grande flashback. Prima vediamo la situazione finale del protagonista, poi il racconto torna indietro e ricostruisce gli eventi che lo hanno portato a diventare “il fu Mattia Pascal”.

Con _La coscienza di Zeno_ ci sono evidenti somiglianze: anche lì la narrazione è in prima persona, il punto di vista è soggettivo e il racconto è retrospettivo. In entrambi i casi il narratore non è del tutto affidabile e il lettore deve sempre ricordare che la realtà narrata passa attraverso una coscienza individuale. La differenza principale è che in Svevo la scrittura nasce come autoanalisi legata alla psicoanalisi, mentre in Pirandello la narrazione serve soprattutto a mettere in scena il problema dell’identità e della maschera. Inoltre Zeno è impegnato soprattutto a interpretare se stesso, mentre Mattia racconta una vicenda paradossale che dimostra l’impossibilità di liberarsi davvero dalla forma sociale.
...
## 7. Perché Mattia Pascal abbandona l’identità di Adriano Meis e torna ad essere Mattia Pascal? Cosa gli accade al suo ritorno a Miragno? Come si conclude quindi la vicenda?

Mattia Pascal abbandona l’identità di Adriano Meis perché capisce che quella falsa libertà è impraticabile. All’inizio la nuova identità gli sembra un’occasione di evasione: liberato dalla famiglia, dai debiti e dalla sua vecchia vita, può finalmente vivere senza vincoli. Ben presto però si rende conto che Adriano Meis è una maschera vuota. Non avendo documenti e un’esistenza legale riconosciuta, non può compiere gli atti fondamentali della vita civile: non può sposarsi, non può denunciare un furto, non può possedere davvero una casa, non può inserirsi in modo stabile nella società. Quando si innamora di Adriana comprende definitivamente che una vita senza identità legale è impossibile.
...
# 1. Differenza tra arte tradizionale e arte umoristica. Differenza tra comico e umoristico. Ruolo della riflessione

Per **Luigi Pirandello**, l’arte tradizionale e l’arte umoristica sono profondamente diverse.

## Arte tradizionale

L’arte tradizionale cerca di rappresentare la realtà in modo **ordinato, coerente e verosimile**.  
Si basa su:
...
- unità psicologica dei personaggi.
    

La realtà appare quindi **stabile e comprensibile**.

## Arte umoristica

L’arte umoristica invece mostra la **contraddizione della realtà e dell’identità umana**.  
L’uomo non è coerente ma diviso tra:
...
Per questo l’arte umoristica rivela **la crisi delle certezze e delle identità**.
...
Il comico nasce da una **percezione immediata del contrario**.

Esempio classico di Pirandello:

- una vecchia signora vestita da ragazza.
    

La situazione appare ridicola e provoca **una risata immediata**.

### Umoristico

L’umoristico nasce dal **sentimento del contrario**.

Se riflettiamo sulla stessa scena capiamo che la donna forse si veste così perché:

- ha paura della vecchiaia
    
- vuole sentirsi ancora giovane.
    

Quindi alla risata si unisce **una sensazione di pietà e tristezza**.

---

## Ruolo della riflessione

La **riflessione è fondamentale**.

- nel **comico** la riflessione non interviene: si ride subito.
    
- nell’**umoristico** la riflessione interviene dopo la percezione iniziale e ci fa vedere il lato tragico della situazione.
    

Per questo l’umorismo pirandelliano unisce sempre **comico e tragico**.

---

# 2. Comicità e umorismo nel racconto _Il treno ha fischiato_

Nel racconto **Il treno ha fischiato** il protagonista è Belluca, un impiegato sfruttato e oppresso dalla vita.

## Aspetto comico

All’inizio della storia Belluca viene considerato pazzo perché improvvisamente:

- si ribella al lavoro
    
- parla in modo strano
    
- ripete: **“il treno ha fischiato!”**
    

I colleghi ridono e lo giudicano folle.  
Questa è la **dimensione comica**: la situazione appare ridicola e incomprensibile.

---

## Aspetto umoristico

Quando però si scopre la sua situazione familiare cambia tutto.

Belluca vive:

- con molte donne cieche o malate
    
- in una casa piena di problemi
    
- in una condizione di oppressione continua.
    

Il fischio del treno gli fa immaginare **la libertà e il viaggio**, permettendogli di evadere mentalmente dalla sua vita.

Qui nasce l’**umorismo**:

- non ridiamo più
    
- proviamo comprensione e pietà per la sua condizione.
    

---

# 3. Dialettica tra forma e vita e presenza nel racconto

Uno dei concetti fondamentali della filosofia di Pirandello è la **dialettica tra vita e forma**.
...
La **forma** è ciò che blocca la vita:
...
Le forme imprigionano il flusso vitale.

---

## Nel racconto

Nel _Treno ha fischiato_:

- la **forma** è la vita di Belluca come impiegato e uomo sottomesso.
    
- la **vita** esplode nel momento in cui sente il treno fischiare.
    

Il fischio rappresenta **la possibilità di evadere mentalmente dalla forma**.

---

# 4. Alienazione, forma-vita e relativismo nella _Patente_

Nel racconto **La patente** questi tre concetti sono molto evidenti.

## Alienazione

Rosario Chiàrchiaro è considerato uno **iettatore**.
...
È quindi **alienato socialmente**.

---

## Forma e vita

La società gli impone una **forma**: quella dello iettatore.

Per sopravvivere Chiàrchiaro decide di **accettare questa maschera** e chiede la patente ufficiale.

La forma sociale diventa quindi **una condanna ma anche un mezzo di sopravvivenza**.

---

## Relativismo

Il racconto mostra anche il **relativismo pirandelliano**.

- per la legge la iettatura non esiste
    
- per la società esiste eccome.
    

La realtà dipende quindi **dal punto di vista degli uomini**.

---

# 5. Voce narrante, punto di vista e intreccio nel _Fu Mattia Pascal_ e confronto con Zeno

Nel romanzo **Il fu Mattia Pascal** la narrazione è molto innovativa.

## Voce narrante

Il narratore è **Mattia Pascal stesso**.

Scrive la sua storia in **prima persona**.
...
- in parte **inaffidabile**.
    

Il lettore conosce i fatti solo attraverso la sua prospettiva.

---

## Intreccio

Il romanzo è costruito come un **grande flashback**:

1. Mattia racconta la storia dopo gli eventi.
    
2. ricostruisce la sua vita.
    
3. spiega come è diventato “il fu Mattia Pascal”.
    

---

## Confronto con _La coscienza di Zeno_

Il romanzo **La coscienza di Zeno** ha alcune somiglianze.
...
- racconto retrospettivo.
    

### Differenze

- Zeno scrive per **analisi psicoanalitica**.
    
- Mattia Pascal scrive per **raccontare una vicenda paradossale di identità**.
    

In Pirandello il tema centrale è **la crisi dell’identità**, mentre in Svevo è **l’analisi psicologica dell’individuo**.

---

# 6. Significato simbolico della Premessa seconda

La **Premessa seconda** del romanzo ha un forte valore simbolico.

## La chiesa sconsacrata

Mattia scrive in una **chiesa sconsacrata e polverosa**.

Questo ambiente rappresenta:

- la perdita dei valori tradizionali
...
Don Eligio cerca di **mettere ordine nei libri della biblioteca**.

Rappresenta:

- la ragione
    
- il tentativo umano di organizzare il caos.
    

Ma la biblioteca resta una **confusione di libri diversi**, simbolo della realtà caotica.

---

## Maledetto Copernico

Mattia “maledice Copernico” perché la scoperta che la Terra gira attorno al Sole ha distrutto l’idea che l’uomo sia **al centro dell’universo**.

L’uomo diventa quindi:

- piccolo
    
- insignificante
    
- simile a un “vermuccio”.
    

---

# 7. Perché Mattia abbandona Adriano Meis

Mattia Pascal crea la falsa identità di **Adriano Meis** per essere libero.

Ma scopre che questa libertà è impossibile.

Infatti Adriano Meis:

- non ha documenti
    
- non può sposarsi
    
- non può denunciare un furto.
    

Quando si innamora di Adriana capisce che **non può vivere senza identità legale**.

Per questo finge il suicidio di Adriano Meis e torna a Miragno.

---

## Cosa accade a Miragno

Al suo ritorno scopre che:
...
Mattia decide quindi **di non riprendersi la moglie**.

---

## Conclusione della vicenda

Mattia resta senza identità:

- non è più Adriano Meis
    
- ma non è più nemmeno Mattia Pascal.
    

Diventa **“il fu Mattia Pascal”**, un uomo escluso dalla vita.

---

# 8. Perché la Figliastra ride nella scena dei Sei personaggi

Nell’opera **Sei personaggi in cerca d'autore** la scena centrale è quella dell’incontro tra il Padre e la Figliastra nel bordello di Madama Pace.

Prima la scena viene **rivissuta dai personaggi**, poi viene **recitata dagli attori**.

---

## Perché la Figliastra ride

La Figliastra ride perché vede che:

- gli attori ripetono le stesse battute
    
- ma non provano le stesse emozioni.
    

Gli attori stanno **imitando la scena**, ma non hanno vissuto il dramma.
...
- infine si scontra con il capocomico.
    

Vuole dimostrare che **il teatro non può rappresentare davvero la vita vissuta**.

---

## Significato

Questa scena mostra il tema centrale dell’opera:

👉 la differenza tra **vita reale e rappresentazione teatrale**.

I personaggi sono più veri degli attori perché **il loro dramma è reale e immutabile**.

---

Se vuoi, posso anche farti **le 10 frasi chiave su Pirandello che i professori vogliono sempre sentire**, così in interrogazione sembri preparatissimo.